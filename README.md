...
**Ребаланс:** раз в `REBALANCE_INTERVAL_SEC` (по умолчанию 7 дней) — деление **80/20 от текущей суммы**.  
При **+20%** на satellite (`SATELLITE_PROFIT_REBALANCE_PCT`) — полная ликвидация, весь капитал в кэш и снова **80/20** (прибыль фиксируется в core).
